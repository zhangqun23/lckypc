...
app.config([ '$routeProvider', function($routeProvider) {
	$routeProvider.when('/remoAnalyzeList', {
		templateUrl : '/lckypc/jsp/reportForm/remoAnalyzeList.html',
		controller : 'ReportController'
	}).when('/projectList', {
		templateUrl : '/lckypc/jsp/reportForm/projectList.html',
		controller : 'ReportController'
	}).when('/unGetContList', {
		templateUrl : '/lckypc/jsp/reportForm/unGetContList.html',
		controller : 'ReportController'
	}).when('/paymentPlanList', {
		templateUrl : '/lckypc/jsp/reportForm/paymentPlanList.html',
		controller : 'ReportController'
	}).when('/summarySheet', {
		templateUrl : '/lckypc/jsp/reportForm/summarySheet.html',
		controller : 'ReportController'
	}).when('/projectSummaryList', {
		templateUrl : '/lckypc/jsp/reportForm/projectSummaryList.html',
		controller : 'ReportController'
	})
} ]);
