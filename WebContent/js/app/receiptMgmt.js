...
receiptapp.config([ '$routeProvider', function($routeProvider) {
	$routeProvider.when('/receiptInfo', {
		templateUrl : '/lckypc/jsp/billInformation/receiptInfo.html',
		controller : 'ReceiptController'
	}).when('/receiptList', {
		templateUrl : '/lckypc/jsp/billInformation/receiptList.html',
		controller : 'ReceiptController'
	}).when('/receiptAdd', {
		templateUrl : '/lckypc/jsp/billInformation/receiptAdd.html',
		controller : 'ReceiptController'
	}).when('/receiptDetail', {
		templateUrl : '/lckypc/jsp/billInformation/receiptDetail.html',
		controller : 'ReceiptController'
	})
} ]);
receiptapp.constant('baseUrl', '/lckypc/');
