				...
				function($routeProvider) {
					$routeProvider
							.when(
									'/contractList',
									{
										templateUrl : '/lckypc/jsp/contractInformation/contractList.html',
							...
							.when(
									'/contractAdd',
									{
										templateUrl : '/lckypc/jsp/contractInformation/contractAdd.html',
										controller : 'ContractController'
									})
							.when(
									'/contractDetail',
									{
										templateUrl : '/lckypc/jsp/contractInformation/contractDetail.html',
										controller : 'ContractController'
									})
							.when(
									'/contractModify',
							...
							.when(
									'/contractInfo',
									{
										templateUrl : '/lckypc/jsp/contractInformation/contractInfo.html',
										controller : 'ContractController'
									})
							.when(
									'/contractUpdate',
									{
										templateUrl : '/lckypc/jsp/contractInformation/contractUpdate.html',
										controller : 'ContractController'
									})
							.when(
									'/prstInfo',
									{
										templateUrl : '/lckypc/jsp/assistant2/contractInformation/contractInfo.html',
										controller : 'ContractController'
									})
							.when(
									'/renoInfo',
							...
							.when(
									'/contractRecord',
									{
										templateUrl : '/lckypc/jsp/contractInformation/contractRecord.html',
										controller : 'ContractController'
									})
							.when(
									'/stopedContract',
