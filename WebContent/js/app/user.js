...
app.config([ '$routeProvider', function($routeProvider) {
	$routeProvider.when('/roleAdd', {
		templateUrl : '/lckypc/jsp/systemManagement/roleAdd.html',
		controller : 'userController'
	}).when('/roleList', {
		templateUrl : '/lckypc/jsp/systemManagement/roleList.html',
		controller : 'userController'
	}).when('/userList', {
		templateUrl : '/lckypc/jsp/systemManagement/userList.html',
		controller : 'userController'
	});
} ]);
